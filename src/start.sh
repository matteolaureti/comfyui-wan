...
############################################
# WAN 2.2 — I2V / T2V — FP16 / FP8 bundles #
############################################

# I2V FP16
if [ "${download_wan22_i2v_fp16}" = "true" ]; then
  echo "Downloading WAN 2.2 I2V FP16 bundle..."
  ...
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/text_encoders/umt5_xxl_fp16.safetensors"                                      "$TEXT_ENCODERS_DIR/umt5_xxl_fp16.safetensors"
fi

# T2V FP16
if [ "${download_wan22_t2v_fp16}" = "true" ]; then
  echo "Downloading WAN 2.2 T2V FP16 bundle..."
  ...
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/vae/wan2.2_vae.safetensors"                                                  "$VAE_DIR/wan2.2_vae.safetensors"
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/loras/wan2.2_t2v_lightx2v_4steps_lora_v1.1_high_noise.safetensors"           "$LORAS_DIR/wan2.2_t2v_lightx2v_4steps_lora_v1.1_high_noise.safetensors"
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/loras/wan2.2_t2v_lightx2v_4steps_lora_v1.1_low_noise.safetensors"            "$LORAS_DIR/wan2.2_t2v_lightx2v_4steps_lora_v1.1_low_noise.safetensors"
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/text_encoders/umt5_xxl_fp16.safetensors"                                      "$TEXT_ENCODERS_DIR/umt5_xxl_fp16.safetensors"
fi

# I2V FP8
if [ "${download_wan22_i2v_fp8}" = "true" ]; then
  echo "Downloading WAN 2.2 I2V FP8 bundle..."
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_i2v_high_noise_14B_fp8_scaled.safetensors" "$DIFFUSION_MODELS_DIR/wan2.2_i2v_high_noise_14B_fp8_scaled.safetensors"
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_i2v_low_noise_14B_fp8_scaled.safetensors"  "$DIFFUSION_MODELS_DIR/wan2.2_i2v_low_noise_14B_fp8_scaled.safetensors"
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/vae/wan2.2_vae.safetensors"                                                   "$VAE_DIR/wan2.2_vae.safetensors"
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/loras/wan2.2_i2v_lightx2v_4steps_lora_v1_high_noise.safetensors"              "$LORAS_DIR/wan2.2_i2v_lightx2v_4steps_lora_v1_high_noise.safetensors"
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/loras/wan2.2_i2v_lightx2v_4steps_lora_v1_low_noise.safetensors"               "$LORAS_DIR/wan2.2_i2v_lightx2v_4steps_lora_v1_low_noise.safetensors"
...
if [ "${download_wan22_t2v_fp8}" = "true" ]; then
  echo "Downloading WAN 2.2 T2V FP8 bundle..."
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_t2v_high_noise_14B_fp8_scaled.safetensors" "$DIFFUSION_MODELS_DIR/wan2.2_t2v_high_noise_14B_fp8_scaled.safetensors"
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/diffusion_models/wan2.2_t2v_low_noise_14B_fp8_scaled.safetensors"  "$DIFFUSION_MODELS_DIR/wan2.2_t2v_low_noise_14B_fp8_scaled.safetensors"
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/vae/wan2.2_vae.safetensors"                                                   "$VAE_DIR/wan2.2_vae.safetensors"
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/loras/wan2.2_t2v_lightx2v_4steps_lora_v1.1_high_noise.safetensors"            "$LORAS_DIR/wan2.2_t2v_lightx2v_4steps_lora_v1.1_high_noise.safetensors"
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/loras/wan2.2_t2v_lightx2v_4steps_lora_v1.1_low_noise.safetensors"             "$LORAS_DIR/wan2.2_t2v_lightx2v_4steps_lora_v1.1_low_noise.safetensors"
  download_model "https://huggingface.co/Comfy-Org/Wan_2.2_ComfyUI_Repackaged/resolve/main/split_files/text_encoders/umt5_xxl_fp8_e4m3fn_scaled.safetensors"                          "$TEXT_ENCODERS_DIR/umt5_xxl_fp8_e4m3fn_scaled.safetensors"
...
#########################################
# Meigen InfiniteTalk helper (optional) #
#########################################
if [ "${download_meigen_infinitetalk}" = "true" ]; then
  echo "Downloading Meigen InfiniteTalk bundle..."
  download_model "https://huggingface.co/Comfy-Org/Wan_2.1_ComfyUI_repackaged/resolve/main/split_files/diffusion_models/wan2.1_i2v_720p_14B_fp8_e4m3fn.safetensors" "$DIFFUSION_MODELS_DIR/wan2.1_i2v_720p_14B_fp8_e4m3fn.safetensors"
  ...
  download_model "https://huggingface.co/MeiGen-AI/InfiniteTalk/resolve/main/comfyui/infinitetalk_single.safetensors" "$DIFFUSION_MODELS_DIR/infinitetalk_single.safetensors"
fi
